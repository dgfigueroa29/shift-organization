...
application {
    mainClass = "com.shiftorganization.lambda.notifications.MainKt"
}

tasks.shadowJar {
    archiveBaseName = "notifications"
    mergeServiceFiles()
    manifest {
        attributes["Main-Class"] = "com.shiftorganization.lambda.notifications.NotificationsModuleKt"
    }
}
