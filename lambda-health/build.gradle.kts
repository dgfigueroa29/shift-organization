...
application {
    mainClass = "com.shiftorganization.lambda.health.MainKt"
}

tasks.shadowJar {
    archiveBaseName = "health"
    mergeServiceFiles()
    manifest {
        attributes["Main-Class"] = "com.shiftorganization.lambda.health.HealthModuleKt"
    }
}
